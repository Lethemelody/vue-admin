<template>
	<el-dialog v-model="dialogVisible" width="550px" append-to-body center @closed="closed" title="修改密码">
		<el-form ref="formRef" :model="formData" :rules="rules" class="user-form" label-width="100px" status-icon>
			<el-form-item label="旧密码:" prop="oldpwd">
				<el-input v-model="formData.oldpwd" type="password" placeholder="请输入旧密码" />
			</el-form-item>
...
<script setup>
	...
	const onSubmit = () => {
		formRef.value.validate((valid, fields) => {
			...
			utils.showLoadding();
			api.post("/api/user/changepwd", JSON.stringify({
