import {
  init,
  throttle
} from "./chunk-7V4FXQY5.js";
import {
  Vue2
} from "./chunk-7QDSFKCU.js";
import {
  computed,
  defineComponent,
  getCurrentInstance,
  ...
  watch,
  watchEffect
} from "./chunk-EYWDJVS6.js";
import {
  init_define_process_env
} from "./chunk-4EE6KXUH.js";
...
function y(e) {
  return t = Object.create(null), b.forEach(function(n) {
    t[n] = function(t2) {
      return function() {
...
!function(e, t) {
  if (e && typeof document != "undefined") {
    var n, r = t.prepend === true ? "prepend" : "append", o = t.singleTag === true, i = typeof t.container == "string" ? document.querySelector(t.container) : document.getElementsByTagName("head")[0];
    if (o) {
      var a = z.indexOf(i);
      a === -1 && (a = z.push(i) - 1, L[a] = {}), n = L[a] && L[a][r] ? L[a][r] : L[a][r] = u();
    } else
      n = u();
...
var C = defineComponent({ name: "echarts", props: m(m({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, x), _), inheritAttrs: false, setup: function(i, a) {
  ...
  function N(e) {
    if (b2.value) {
      ...
      n || (n = {}, Object.keys(f).filter(function(e2) {
        ...
        t2.substring(t2.length - 4) === "Once" && (t2 = "~".concat(t2.substring(0, t2.length - 4))), n[t2] = f[e2];
        ...
        if (r2) {
          ...
          var i2 = t;
          if (o.indexOf("zr:") === 0 && (i2 = t.getZr(), o = o.substring(3)), r2.__once__) {
            delete r2.__once__;
            var a2 = r2;
            r2 = function() {
  ...
  watch(T2, function(t) {
    typeof q == "function" && (q(), q = null), t || (q = watch(function() {
      ...
      e && (x2.value ? x2.value.setOption(e, m({ notMerge: e.value !== (t2 == null ? void 0 : t2.value) }, B.value)) : N());
    }, { deep: true }));
  ...
  return function(e, i2, a2) {
    var u = inject("ecLoadingOptions", {}), c = computed(function() {
      return m(m({}, unref(u)), a2 == null ? void 0 : a2.value);
    });
